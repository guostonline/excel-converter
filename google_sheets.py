...
class GoogleSheetsService:
    ...
    def upload_quali_nv_to_google_sheets(self, excel_path="excel/finale_jour.xlsx", spreadsheet_id="1cRNqohML-mZ2mMqXIfQlPPDQUmRGLmRzDfp3j0wpte4", worksheet_name="quali SOM VMM", credentials_path="google.json"):
        """
